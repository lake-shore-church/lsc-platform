export const CHURCH = {
  ...
  youtube: "https://www.youtube.com/@lschurchchicago",
  bookUrl: "https://www.amazon.com/s?k=Craig+Brian+Larson+Know",
  featuredSeries: {
    title: "The Sheer Goodness of Jesus",
    subtitle: "A series by Pastor Brian",
  },
} as const;
