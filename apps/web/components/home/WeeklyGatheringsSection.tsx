import type { ResolvedThisWeek, SiteConfig, Sermon } from "@repo/cms";
...
export async function WeeklyGatheringsSection({
  ...
  const sermonTitle =
    thisWeek.sermon_title?.trim() ||
    resolveUpcomingSermonTitle(config, latestSermon, t("upcoming_sermon_default_title"));
  const sermonDesc =
